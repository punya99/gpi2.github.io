! function(e) {
    ...
    n.p = "//static.hsappstatic.net/HubspotToolsMenu/static-1.138/";
    n(n.s = 3)
}([function(e, t) {
    e.exports = "//static.hsappstatic.net/HubspotToolsMenu/static-1.138/js/sprocket_white.svg"
}, function(e, t) {
    e.exports = "//static.hsappstatic.net/HubspotToolsMenu/static-1.138/js/sprocket_orange.svg"
}, function(e, t) {
    e.exports = "//static.hsappstatic.net/HubspotToolsMenu/static-1.138/css/toolsmenu.css"
}, function(e, t, n) {
    "use strict";
    n.r(t);
    ...
    class m {
        ...
        showToolsMenuIfAuthor() {
            ...
            if (-1 !== window.location.pathname.indexOf("_hcms/preview/template")) return;
        ...
        showAppLinks(e, t) {
            ...
            let s = "";
            e.forEach(e => {
                s += `        <li><a target='_blank' href='${e[1]}'>\n        ${e[0]}\n        </a></li>      `
            });
            if (this.permissionObj.permissions.includes("CAN_PREVIEW_ENVIRONMENTS")) {
                s += `        <li><a class="hs-environment-buffer-on">${t.VIEW_BUFFER}</a></li>        <li><a class="hs-environment-buffer-off">${t.VIEW_HARD}</a></li>      `;
                s += `        <li><a class="hs-environment-staging">${t.VIEW_STAGING}</a></li>        <li><a class="hs-environment-production">${t.VIEW_PRODUCTION}</a></li>      `
            }
            const i = `<link rel="stylesheet" href="${h.a}" />`,
    ...
    class f {
        ...
        r() || ("loading" === document.readyState ? document.addEventListener("DOMContentLoaded", (function t() {
            e();
