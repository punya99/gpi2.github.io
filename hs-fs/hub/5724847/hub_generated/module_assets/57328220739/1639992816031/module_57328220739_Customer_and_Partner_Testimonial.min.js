var module_57328220739 = function() {
    var __hs_messages = {};
    i18n_getmessage = function() {
        ...
        var factory;
        factory = function($) {
            var mfp, _prevStatus, _body, _document, _prevContentType, _wrapClasses, _currPopupType, MagnificPopup = function() {},
                _isJQ = !!window.jQuery,
                _window = $(window),
            ...
            MagnificPopup.prototype = {
                ...
                init: function() {
                    ...
                    mfp.isIE7 = -1 !== appVersion.indexOf("MSIE 7."), mfp.isIE8 = -1 !== appVersion.indexOf("MSIE 8."), mfp.isLowIE = mfp.isIE7 || mfp.isIE8, mfp.isAndroid = /android/gi.test(appVersion), mfp.isIOS = /iphone|ipad|ipod/gi.test(appVersion), mfp.supportsTransition = function() {
                ...
                _openClick: function(e, el, options) {
                    if ((void 0 !== options.midClick ? options.midClick : $.magnificPopup.defaults.midClick) || 2 !== e.which && !e.ctrlKey && !e.metaKey) {
            ...
            var _imgInterval, hasMozTransform, _getTitle = function(item) {
                ...
                proto: {
                    initImage: function() {
                        ...
                        mfp.types.push("image"), _mfpOn("Open" + ns, (function() {
                            ...
                            imgSt.cursor && _body.removeClass(imgSt.cursor), _window.off("resize.mfp")
            ...
            var supportsTouch, unbindTouchMove, ns, _getLoopedId = function(index) {
            ...
            }), supportsTouch = "ontouchstart" in window, unbindTouchMove = function() {
                _window.off("touchmove" + ns + " touchend" + ns)
            }, ns = ".mfpFastClick", $.fn.mfpFastClick = function(callback) {
                return $(this).each((function() {
                    var lock, timeout, startX, startY, pointerMoved, point, numPointers, elem = $(this);
        ...
        }, "function" == typeof define && define.amd ? define(["jquery"], factory) : "object" == typeof exports ? factory(require("jquery")) : factory(window.jQuery || window.Zepto), $(".popup-youtube").magnificPopup({
            disableOn: 200,
            type: "iframe",
            mainClass: "mfp-fade",
            removalDelay: 160,
            preloader: !1,
            fixedContentPos: !1
        }), "popup" == location.hash.substr(1) && $(".popup-youtube").click()
    }))
}();